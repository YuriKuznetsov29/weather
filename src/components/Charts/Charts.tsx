...
const Charts = () => {
    ...
    const sunRef = useRef<ChartJS>(null)

    const wether = useAppSelector(currentWether)
    const location = useAppSelector(currentLocation)
                ...
                <>
                    ...
                    <div className={styles.chartWrapper}>
                        <div className={styles.chart_container}>
                            {   
                                wether ? 
                                <Chart ref={sunRef} type='line' data={sunChartConfig.data} options={sunChartConfig.options}/> 
                                : <div className={styles.loadingChart}>
                                    <div className={styles.gradient}></div>
                                </div>
                            }
